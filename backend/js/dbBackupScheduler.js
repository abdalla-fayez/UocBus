...
// Schedule the backup to run every day at 11:55 PM
schedule.scheduleJob('55 23 * * *', backupDatabase);

logger.info('Database backup scheduler initialized, running daily at 11:55 PM.');
